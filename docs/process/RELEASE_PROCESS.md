...
5. **GitHub Release appears**
   - View at: `https://github.com/finografic/lucide-manager/releases`
...
1. **GitHub Release created**
   - `https://github.com/finografic/lucide-manager/releases`

2. **Package published**
   - `https://github.com/finografic/lucide-manager/packages`

3. **Workflow succeeded**
   - `https://github.com/finografic/lucide-manager/actions`
